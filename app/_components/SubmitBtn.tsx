...
export default function SubmitBtn({ text, className }: { text: string, className: string }) {
  ...
  return (
    <button
      className={`tracking-wider ${className} mb-2 flex justify-center bg-card p-4 py-2 rounded-lg ${false && "opacity-80"} duration-200 hover:text-my-black hover:border hover:border-black`}
      disabled={pending}
      type="submit" >
